  ...
  return (
    <div>
      <div className="navbar bg-transparent p-8">
        ...
        {/* //? User Profile */}
         {
          user ?   <div onClick={() => isShowProfile(!showProfile)} className="relative navbar-end">
         ...
         <ul className="menu absolute top-12 menu-sm mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
            ...
            <li className="active:bg-[#c1700d] focus:bg-[#fd9414]"><a>{user?.displayName}</a></li>
            <li className="active:bg-[#d27a10] focus:bg-[#fd9414]"><a>{user?.email}</a></li>
            <li onClick={handleSignOut} className="active:bg-[#bf700f] focus:bg-[#fd9414]"><a>Logout</a></li>
          </ul>}
        </div>
        :
